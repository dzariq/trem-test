            ...
            <Tabs value={analysisTab} onValueChange={setAnalysisTab} className="w-full">
              ...
              <TabsContent value="trends" className="space-y-4">
                ...
                <div className="p-4 rounded-xl bg-gradient-to-r from-accent/50 to-accent/30 border border-border/50 space-y-3">
                  ...
                  {/* Period Toggle */}
                  <div className="grid grid-cols-5 gap-1 bg-muted/50 p-1 rounded-lg">
                    {([{
                    key: "1year",
                    label: "1Y"
                  }, {
                    ...
                    key,
                    label
                  }) => <button key={key} onClick={() => setTrendPeriod(key)} className={`py-1.5 text-xs font-medium rounded-md transition-all text-center ${trendPeriod === key ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}>
                        {label}
                      </button>)}
                  </div>
                </div>
