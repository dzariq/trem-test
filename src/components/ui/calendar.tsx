  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today:
          "font-semibold text-foreground [&::before]:content-[''] [&::before]:absolute [&::before]:h-8 [&::before]:w-8 [&::before]:rounded-full [&::before]:ring-2 [&::before]:ring-green-500 [&::before]:bg-transparent [&::before]:z-[-1] aria-selected:[&::before]:ring-0",
        day_outside:
