...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    <DrawerOverlay />
      ...
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-[100] mt-24 flex h-auto flex-col rounded-t-[10px] border bg-background pb-[var(--safe-bottom)] max-h-[calc(100vh-var(--safe-top)-var(--safe-bottom))] overflow-hidden",
        className,
      )}
      {...props}
    >
