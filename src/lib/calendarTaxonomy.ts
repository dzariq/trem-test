...
export const CALENDAR_TAXONOMY: TaxonomyGroup[] = [
  {
    ...
    subtypes: [
      ...
      { name: "Cambridge Exam", color: "#991b1b" },
      { name: "Mid-Year Exam", color: "#dc2626" },
      { name: "Year-End Exam", color: "#b91c1c" },
      { name: "Cambridge Exam – IGCSE", color: "#991b1b" },
  ...
  },
  {
    ...
    color: "#8b5cf6",
    subtypes: [
      { name: "Special Event (Major)", color: "#8b5cf6" },
      { name: "Internal Event", color: "#a78bfa" },
      { name: "External Event", color: "#7c3aed" },
      { name: "Open Day", color: "#c4b5fd" },
      { name: "Field Trip", color: "#6d28d9" },
    ],
  },
  {
    name: "Staff & Admin",
