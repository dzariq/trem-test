...
export const detailedClassGrades: Record<string, Record<string, Record<string, {
  ...
  "5A": {
    ...
    "STU-004": {
      "Mathematics": { attitude: 4, homework: 3, quiz: 3, exam: 25 },
      "Science": { attitude: 3, homework: 2, quiz: 3, exam: 22 },
      "English": { attitude: 3, homework: 2, quiz: 2, exam: 20 },
      "Arts": { attitude: 5, homework: 4, quiz: 4, exam: 28 },
      "Chinese as a Second Language": { attitude: 4, homework: 3, quiz: 3, exam: 24 },
      "Physical Education": { attitude: 6, homework: 5, quiz: 5, exam: 30 },
    },
    "STU-005": {
    ...
    "STU-006": {
      "Mathematics": { attitude: 5, homework: 4, quiz: 4, exam: 28 },
      "Science": { attitude: 4, homework: 3, quiz: 3, exam: 25 },
      "English": { attitude: 4, homework: 3, quiz: 3, exam: 24 },
      "Arts": { attitude: 6, homework: 5, quiz: 5, exam: 32 },
      "Chinese as a Second Language": { attitude: 5, homework: 4, quiz: 4, exam: 27 },
      "Physical Education": { attitude: 7, homework: 6, quiz: 6, exam: 35 },
    },
    "STU-007": {
