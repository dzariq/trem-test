...
export const classRosters: Record<string, ClassStudent[]> = {
  "5A": [
    { id: "STU-001", name: "Emma Johnson", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-002", name: "Liam Smith", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "blue", remarks: "Nut allergy - carry EpiPen", joinDate: "2022-01-10" },
    { id: "STU-003", name: "Olivia Brown", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "green", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-004", name: "Noah Davis", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "yellow", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-005", name: "Ava Wilson", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "red", remarks: "Asthma - uses inhaler", joinDate: "2023-01-05" },
    { id: "STU-006", name: "James Miller", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "blue", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-007", name: "Isabella Garcia", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "green", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-008", name: "Benjamin Martinez", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "yellow", remarks: "Requires extra support in Math", joinDate: "2022-01-10" },
    { id: "STU-009", name: "Sophia Anderson", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-010", name: "Lucas Taylor", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "blue", remarks: "", joinDate: "2023-08-15" },
    { id: "STU-011", name: "Mia Thomas", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "green", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-012", name: "Ethan Jackson", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "yellow", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-013", name: "Charlotte White", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-014", name: "Alexander Harris", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "blue", remarks: "Diabetic - monitors blood sugar", joinDate: "2022-01-10" },
    { id: "STU-015", name: "Amelia Martin", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "green", remarks: "", joinDate: "2024-01-08" },
    { id: "STU-016", name: "Daniel Thompson", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "yellow", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-017", name: "Harper Robinson", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-018", name: "Matthew Clark", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "blue", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-019", name: "Evelyn Lewis", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "green", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-020", name: "Michael Lee", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "yellow", remarks: "Learning support for English", joinDate: "2025-01-06" },
  ],
  "5B": [
    { id: "STU-021", name: "Abigail Walker", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-022", name: "Sebastian Hall", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "blue", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-023", name: "Emily Young", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "green", remarks: "Gifted program - advanced Math", joinDate: "2022-01-10" },
    { id: "STU-024", name: "Jack Allen", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "yellow", remarks: "", joinDate: "2023-08-15" },
    { id: "STU-025", name: "Elizabeth King", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-026", name: "Henry Wright", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "blue", remarks: "ADHD - seated in front", joinDate: "2022-01-10" },
    { id: "STU-027", name: "Sofia Scott", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "green", remarks: "", joinDate: "2022-01-10" },
    { id: "STU-028", name: "Owen Green", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "yellow", remarks: "", joinDate: "2024-01-08" },
  ],
  "4A": [
    { id: "STU-031", name: "Grace Adams", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2023-01-05" },
    { id: "STU-032", name: "William Baker", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "blue", remarks: "", joinDate: "2023-01-05" },
    { id: "STU-033", name: "Chloe Carter", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "green", remarks: "Lactose intolerant", joinDate: "2023-01-05" },
    { id: "STU-034", name: "Logan Collins", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "yellow", remarks: "", joinDate: "2023-01-05" },
    { id: "STU-035", name: "Lily Edwards", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "red", remarks: "", joinDate: "2023-01-05" },
    { id: "STU-036", name: "Mason Foster", photo: null, mealPlan: true, outdoorCCA: false, sportsHouse: "blue", remarks: "", joinDate: "2024-08-12" },
    { id: "STU-037", name: "Zoe Garcia", photo: null, mealPlan: false, outdoorCCA: true, sportsHouse: "green", remarks: "", joinDate: "2023-01-05" },
    { id: "STU-038", name: "Elijah Howard", photo: null, mealPlan: true, outdoorCCA: true, sportsHouse: "yellow", remarks: "Wears glasses - seated near board", joinDate: "2023-01-05" },
  ]
};
...
// Uses subject names from subjectsConfig.ts
export const detailedClassGrades: Record<string, Record<string, Record<string, {
  ...
  "5A": {
    ...
    "STU-001": {
      ...
      "English (First Language)": { attitude: 10, homework: 9, quiz: 10, exam: 65 },
      "Chinese (Second Language)": { attitude: 10, homework: 10, quiz: 9, exam: 66 },
      "Malay (First Language)": { attitude: 10, homework: 10, quiz: 10, exam: 67 },
      "Biology": { attitude: 9, homework: 10, quiz: 9, exam: 64 },
      "Chemistry": { attitude: 10, homework: 9, quiz: 10, exam: 65 },
      "Physics": { attitude: 9, homework: 9, quiz: 9, exam: 63 },
      "History": { attitude: 10, homework: 10, quiz: 10, exam: 66 },
      "Geography": { attitude: 10, homework: 9, quiz: 10, exam: 65 },
      "ICT": { attitude: 10, homework: 10, quiz: 10, exam: 68 },
    },
    "STU-002": {
      "Mathematics": { attitude: 10, homework: 9, quiz: 10, exam: 65 },
      "Science": { attitude: 10, homework: 10, quiz: 9, exam: 64 },
      "English (First Language)": { attitude: 9, homework: 10, quiz: 9, exam: 63 },
      "Chinese (Second Language)": { attitude: 10, homework: 9, quiz: 10, exam: 64 },
      "Malay (First Language)": { attitude: 9, homework: 10, quiz: 9, exam: 65 },
      "Biology": { attitude: 10, homework: 9, quiz: 10, exam: 63 },
      "Chemistry": { attitude: 9, homework: 10, quiz: 9, exam: 62 },
      "Physics": { attitude: 10, homework: 9, quiz: 10, exam: 64 },
      "History": { attitude: 9, homework: 10, quiz: 9, exam: 64 },
      "Geography": { attitude: 10, homework: 9, quiz: 9, exam: 63 },
      "ICT": { attitude: 10, homework: 10, quiz: 10, exam: 67 },
    },
    // Middle Performers (B/C grades 60-79%)
    "STU-003": {
      "Mathematics": { attitude: 8, homework: 8, quiz: 8, exam: 52 },
      "Science": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      "English (First Language)": { attitude: 7, homework: 8, quiz: 7, exam: 48 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 54 },
      "Biology": { attitude: 8, homework: 7, quiz: 7, exam: 49 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 48 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 47 },
      "History": { attitude: 8, homework: 8, quiz: 8, exam: 51 },
      "Geography": { attitude: 7, homework: 8, quiz: 7, exam: 49 },
      "ICT": { attitude: 9, homework: 8, quiz: 8, exam: 55 },
    },
    "STU-004": {
      "Mathematics": { attitude: 8, homework: 7, quiz: 7, exam: 48 },
      "Science": { attitude: 7, homework: 8, quiz: 7, exam: 46 },
      "English (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 45 },
      "Chinese (Second Language)": { attitude: 7, homework: 7, quiz: 7, exam: 46 },
      "Malay (First Language)": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
      "Biology": { attitude: 7, homework: 7, quiz: 8, exam: 45 },
      "Chemistry": { attitude: 8, homework: 7, quiz: 7, exam: 44 },
      "Physics": { attitude: 7, homework: 8, quiz: 7, exam: 46 },
      "History": { attitude: 8, homework: 7, quiz: 7, exam: 48 },
      "Geography": { attitude: 7, homework: 7, quiz: 8, exam: 47 },
      "ICT": { attitude: 8, homework: 8, quiz: 8, exam: 52 },
    },
    "STU-005": {
      "Mathematics": { attitude: 9, homework: 8, quiz: 8, exam: 54 },
      "Science": { attitude: 8, homework: 8, quiz: 8, exam: 52 },
      "English (First Language)": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      "Chinese (Second Language)": { attitude: 8, homework: 8, quiz: 8, exam: 52 },
      "Malay (First Language)": { attitude: 9, homework: 9, quiz: 8, exam: 56 },
      "Biology": { attitude: 8, homework: 8, quiz: 7, exam: 51 },
      "Chemistry": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      "Physics": { attitude: 9, homework: 8, quiz: 8, exam: 53 },
      "History": { attitude: 8, homework: 8, quiz: 8, exam: 53 },
      "Geography": { attitude: 8, homework: 8, quiz: 7, exam: 51 },
      "ICT": { attitude: 9, homework: 9, quiz: 9, exam: 58 },
    },
    "STU-006": {
      "Mathematics": { attitude: 7, homework: 7, quiz: 7, exam: 46 },
      "Science": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "English (First Language)": { attitude: 7, homework: 7, quiz: 6, exam: 43 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 7, exam: 45 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 48 },
      "Biology": { attitude: 7, homework: 7, quiz: 6, exam: 43 },
      "Chemistry": { attitude: 6, homework: 7, quiz: 7, exam: 42 },
      "Physics": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "History": { attitude: 7, homework: 7, quiz: 7, exam: 46 },
      "Geography": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "ICT": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
    },
    "STU-007": {
      "Mathematics": { attitude: 8, homework: 8, quiz: 8, exam: 50 },
      "Science": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "English (First Language)": { attitude: 7, homework: 8, quiz: 7, exam: 46 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 52 },
      "Biology": { attitude: 8, homework: 8, quiz: 7, exam: 47 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 8, exam: 46 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "History": { attitude: 8, homework: 8, quiz: 8, exam: 50 },
      "Geography": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "ICT": { attitude: 9, homework: 8, quiz: 8, exam: 54 },
    },
    "STU-008": {
      "Mathematics": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "Science": { attitude: 7, homework: 7, quiz: 6, exam: 42 },
      "English (First Language)": { attitude: 6, homework: 6, quiz: 7, exam: 40 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 6, exam: 42 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 46 },
      "Biology": { attitude: 7, homework: 6, quiz: 7, exam: 41 },
      "Chemistry": { attitude: 6, homework: 7, quiz: 6, exam: 40 },
      "Physics": { attitude: 7, homework: 6, quiz: 7, exam: 42 },
      "History": { attitude: 7, homework: 7, quiz: 7, exam: 44 },
      "Geography": { attitude: 7, homework: 6, quiz: 7, exam: 42 },
      "ICT": { attitude: 8, homework: 7, quiz: 7, exam: 48 },
    },
    "STU-009": {
      "Mathematics": { attitude: 8, homework: 8, quiz: 7, exam: 49 },
      "Science": { attitude: 8, homework: 7, quiz: 8, exam: 47 },
      "English (First Language)": { attitude: 7, homework: 7, quiz: 7, exam: 45 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 7, exam: 47 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 51 },
      "Biology": { attitude: 8, homework: 7, quiz: 8, exam: 46 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 45 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 47 },
      "History": { attitude: 8, homework: 8, quiz: 7, exam: 49 },
      "Geography": { attitude: 8, homework: 7, quiz: 8, exam: 47 },
      "ICT": { attitude: 9, homework: 8, quiz: 8, exam: 53 },
    },
    "STU-010": {
      "Mathematics": { attitude: 7, homework: 7, quiz: 8, exam: 48 },
      "Science": { attitude: 8, homework: 7, quiz: 7, exam: 46 },
      "English (First Language)": { attitude: 7, homework: 6, quiz: 7, exam: 43 },
      "Chinese (Second Language)": { attitude: 7, homework: 7, quiz: 7, exam: 45 },
      "Malay (First Language)": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
      "Biology": { attitude: 7, homework: 7, quiz: 7, exam: 45 },
      "Chemistry": { attitude: 8, homework: 7, quiz: 7, exam: 44 },
      "Physics": { attitude: 7, homework: 7, quiz: 8, exam: 46 },
      "History": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "Geography": { attitude: 7, homework: 7, quiz: 7, exam: 46 },
      "ICT": { attitude: 8, homework: 8, quiz: 8, exam: 52 },
    },
    "STU-011": {
      "Mathematics": { attitude: 8, homework: 7, quiz: 7, exam: 47 },
      "Science": { attitude: 7, homework: 7, quiz: 7, exam: 45 },
      "English (First Language)": { attitude: 7, homework: 7, quiz: 6, exam: 42 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "Malay (First Language)": { attitude: 8, homework: 8, quiz: 7, exam: 49 },
      "Biology": { attitude: 7, homework: 7, quiz: 7, exam: 44 },
      "Chemistry": { attitude: 7, homework: 6, quiz: 7, exam: 43 },
      "Physics": { attitude: 8, homework: 7, quiz: 7, exam: 45 },
      "History": { attitude: 7, homework: 7, quiz: 7, exam: 47 },
      "Geography": { attitude: 7, homework: 7, quiz: 6, exam: 45 },
      "ICT": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
    },
    "STU-012": {
      "Mathematics": { attitude: 9, homework: 8, quiz: 8, exam: 53 },
      "Science": { attitude: 8, homework: 8, quiz: 8, exam: 51 },
      "English (First Language)": { attitude: 8, homework: 8, quiz: 8, exam: 49 },
      "Chinese (Second Language)": { attitude: 8, homework: 8, quiz: 8, exam: 51 },
      "Malay (First Language)": { attitude: 9, homework: 9, quiz: 8, exam: 55 },
      "Biology": { attitude: 8, homework: 8, quiz: 8, exam: 50 },
      "Chemistry": { attitude: 8, homework: 8, quiz: 8, exam: 49 },
      "Physics": { attitude: 9, homework: 8, quiz: 8, exam: 51 },
      "History": { attitude: 8, homework: 8, quiz: 8, exam: 53 },
      "Geography": { attitude: 8, homework: 8, quiz: 8, exam: 51 },
      "ICT": { attitude: 9, homework: 9, quiz: 9, exam: 57 },
    },
    "STU-013": {
      "Mathematics": { attitude: 7, homework: 6, quiz: 7, exam: 45 },
      "Science": { attitude: 7, homework: 7, quiz: 6, exam: 43 },
      "English (First Language)": { attitude: 6, homework: 6, quiz: 6, exam: 40 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 6, exam: 43 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 47 },
      "Biology": { attitude: 7, homework: 6, quiz: 7, exam: 42 },
      "Chemistry": { attitude: 6, homework: 7, quiz: 6, exam: 41 },
      "Physics": { attitude: 7, homework: 6, quiz: 7, exam: 43 },
      "History": { attitude: 7, homework: 7, quiz: 7, exam: 45 },
      "Geography": { attitude: 7, homework: 6, quiz: 7, exam: 43 },
      "ICT": { attitude: 8, homework: 7, quiz: 7, exam: 49 },
    },
    "STU-014": {
      "Mathematics": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
      "Science": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "English (First Language)": { attitude: 7, homework: 7, quiz: 7, exam: 46 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 7, exam: 48 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 52 },
      "Biology": { attitude: 8, homework: 7, quiz: 8, exam: 47 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 46 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "History": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
      "Geography": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "ICT": { attitude: 9, homework: 8, quiz: 8, exam: 54 },
    },
    "STU-015": {
      ...
      "English (First Language)": { attitude: 6, homework: 6, quiz: 6, exam: 39 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 6, exam: 42 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 46 },
      "Biology": { attitude: 7, homework: 6, quiz: 7, exam: 41 },
      "Chemistry": { attitude: 6, homework: 7, quiz: 6, exam: 40 },
      "Physics": { attitude: 7, homework: 6, quiz: 7, exam: 42 },
      "History": { attitude: 7, homework: 7, quiz: 6, exam: 44 },
      "Geography": { attitude: 7, homework: 6, quiz: 7, exam: 42 },
      "ICT": { attitude: 8, homework: 7, quiz: 7, exam: 48 },
    },
    "STU-016": {
      ...
      "English (First Language)": { attitude: 7, homework: 7, quiz: 7, exam: 47 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 53 },
      "Biology": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 47 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "History": { attitude: 8, homework: 8, quiz: 8, exam: 51 },
      "Geography": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "ICT": { attitude: 9, homework: 8, quiz: 8, exam: 55 },
    },
    "STU-017": {
      "Mathematics": { attitude: 7, homework: 7, quiz: 7, exam: 46 },
      "Science": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "English (First Language)": { attitude: 6, homework: 7, quiz: 6, exam: 41 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 48 },
      "Biology": { attitude: 7, homework: 6, quiz: 7, exam: 43 },
      "Chemistry": { attitude: 6, homework: 7, quiz: 6, exam: 42 },
      "Physics": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "History": { attitude: 7, homework: 7, quiz: 7, exam: 46 },
      "Geography": { attitude: 7, homework: 6, quiz: 7, exam: 44 },
      "ICT": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
    },
    // At-Risk Students (D/E grades <60%)
    "STU-018": {
      "Mathematics": { attitude: 4, homework: 3, quiz: 4, exam: 28 },
      "Science": { attitude: 4, homework: 4, quiz: 3, exam: 26 },
      "English (First Language)": { attitude: 3, homework: 3, quiz: 3, exam: 24 },
      "Chinese (Second Language)": { attitude: 4, homework: 3, quiz: 4, exam: 27 },
      "Malay (First Language)": { attitude: 5, homework: 4, quiz: 4, exam: 30 },
      "Biology": { attitude: 4, homework: 3, quiz: 4, exam: 25 },
      "Chemistry": { attitude: 3, homework: 4, quiz: 3, exam: 24 },
      "Physics": { attitude: 4, homework: 3, quiz: 4, exam: 26 },
      "History": { attitude: 4, homework: 4, quiz: 4, exam: 28 },
      "Geography": { attitude: 4, homework: 3, quiz: 4, exam: 26 },
      "ICT": { attitude: 5, homework: 5, quiz: 4, exam: 32 },
    },
    "STU-019": {
      "Mathematics": { attitude: 3, homework: 2, quiz: 3, exam: 22 },
      "Science": { attitude: 3, homework: 3, quiz: 2, exam: 20 },
      "English (First Language)": { attitude: 2, homework: 2, quiz: 2, exam: 18 },
      "Chinese (Second Language)": { attitude: 3, homework: 2, quiz: 3, exam: 21 },
      "Malay (First Language)": { attitude: 4, homework: 3, quiz: 3, exam: 24 },
      "Biology": { attitude: 3, homework: 2, quiz: 3, exam: 19 },
      "Chemistry": { attitude: 2, homework: 3, quiz: 2, exam: 18 },
      "Physics": { attitude: 3, homework: 2, quiz: 3, exam: 20 },
      "History": { attitude: 3, homework: 3, quiz: 3, exam: 22 },
      "Geography": { attitude: 3, homework: 2, quiz: 3, exam: 20 },
      "ICT": { attitude: 4, homework: 4, quiz: 3, exam: 26 },
    },
    "STU-020": {
      "Mathematics": { attitude: 5, homework: 4, quiz: 4, exam: 32 },
      "Science": { attitude: 4, homework: 4, quiz: 4, exam: 30 },
      "English (First Language)": { attitude: 4, homework: 3, quiz: 4, exam: 28 },
      "Chinese (Second Language)": { attitude: 4, homework: 4, quiz: 4, exam: 30 },
      "Malay (First Language)": { attitude: 5, homework: 5, quiz: 4, exam: 34 },
      "Biology": { attitude: 4, homework: 4, quiz: 4, exam: 29 },
      "Chemistry": { attitude: 4, homework: 4, quiz: 3, exam: 28 },
      "Physics": { attitude: 5, homework: 4, quiz: 4, exam: 30 },
      "History": { attitude: 5, homework: 4, quiz: 4, exam: 32 },
      "Geography": { attitude: 4, homework: 4, quiz: 4, exam: 30 },
      "ICT": { attitude: 6, homework: 5, quiz: 5, exam: 38 },
    },
  },
  "5B": {
    "STU-021": {
      ...
      "English (First Language)": { attitude: 8, homework: 8, quiz: 8, exam: 55 },
      "Chinese (Second Language)": { attitude: 9, homework: 8, quiz: 8, exam: 57 },
      "Malay (First Language)": { attitude: 10, homework: 9, quiz: 9, exam: 62 },
      "Biology": { attitude: 9, homework: 8, quiz: 8, exam: 57 },
      "Chemistry": { attitude: 8, homework: 9, quiz: 8, exam: 56 },
      "Physics": { attitude: 9, homework: 8, quiz: 9, exam: 58 },
      "History": { attitude: 9, homework: 9, quiz: 8, exam: 60 },
      "Geography": { attitude: 9, homework: 8, quiz: 9, exam: 58 },
      "ICT": { attitude: 10, homework: 10, quiz: 9, exam: 64 },
    },
    "STU-022": {
      "Mathematics": { attitude: 6, homework: 5, quiz: 6, exam: 42 },
      "Science": { attitude: 7, homework: 6, quiz: 5, exam: 40 },
      "English (First Language)": { attitude: 5, homework: 5, quiz: 5, exam: 38 },
      "Chinese (Second Language)": { attitude: 6, homework: 5, quiz: 5, exam: 40 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 6, exam: 45 },
      "Biology": { attitude: 6, homework: 6, quiz: 5, exam: 39 },
      "Chemistry": { attitude: 5, homework: 6, quiz: 5, exam: 38 },
      "Physics": { attitude: 6, homework: 5, quiz: 6, exam: 40 },
      "History": { attitude: 6, homework: 6, quiz: 6, exam: 42 },
      "Geography": { attitude: 6, homework: 5, quiz: 6, exam: 40 },
      "ICT": { attitude: 8, homework: 8, quiz: 7, exam: 50 },
    },
    "STU-023": {
      ...
      "English (First Language)": { attitude: 10, homework: 9, quiz: 10, exam: 65 },
      "Chinese (Second Language)": { attitude: 10, homework: 10, quiz: 9, exam: 66 },
      "Malay (First Language)": { attitude: 10, homework: 10, quiz: 10, exam: 68 },
      "Biology": { attitude: 10, homework: 10, quiz: 10, exam: 66 },
      "Chemistry": { attitude: 10, homework: 10, quiz: 10, exam: 65 },
      "Physics": { attitude: 10, homework: 10, quiz: 10, exam: 67 },
      "History": { attitude: 10, homework: 10, quiz: 10, exam: 69 },
      "Geography": { attitude: 10, homework: 10, quiz: 10, exam: 67 },
      "ICT": { attitude: 10, homework: 10, quiz: 10, exam: 70 },
    },
    "STU-024": {
      "Mathematics": { attitude: 8, homework: 8, quiz: 8, exam: 52 },
      "Science": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      ...
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 54 },
      "Biology": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 48 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      "History": { attitude: 8, homework: 8, quiz: 8, exam: 52 },
      "Geography": { attitude: 8, homework: 7, quiz: 8, exam: 50 },
      "ICT": { attitude: 9, homework: 8, quiz: 8, exam: 55 },
    },
    "STU-025": {
      "Mathematics": { attitude: 7, homework: 7, quiz: 7, exam: 48 },
      "Science": { attitude: 7, homework: 6, quiz: 7, exam: 46 },
      "English (First Language)": { attitude: 6, homework: 7, quiz: 6, exam: 44 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 7, exam: 46 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 50 },
      "Biology": { attitude: 7, homework: 6, quiz: 7, exam: 45 },
      "Chemistry": { attitude: 6, homework: 7, quiz: 6, exam: 44 },
      "Physics": { attitude: 7, homework: 6, quiz: 7, exam: 46 },
      "History": { attitude: 7, homework: 7, quiz: 7, exam: 48 },
      "Geography": { attitude: 7, homework: 6, quiz: 7, exam: 46 },
      "ICT": { attitude: 8, homework: 7, quiz: 7, exam: 52 },
    },
    "STU-026": {
      "Mathematics": { attitude: 9, homework: 8, quiz: 9, exam: 58 },
      "Science": { attitude: 9, homework: 9, quiz: 8, exam: 56 },
      "English (First Language)": { attitude: 8, homework: 8, quiz: 8, exam: 54 },
      "Chinese (Second Language)": { attitude: 9, homework: 8, quiz: 8, exam: 56 },
      "Malay (First Language)": { attitude: 10, homework: 9, quiz: 9, exam: 60 },
      "Biology": { attitude: 9, homework: 8, quiz: 9, exam: 55 },
      "Chemistry": { attitude: 8, homework: 9, quiz: 8, exam: 54 },
      "Physics": { attitude: 9, homework: 8, quiz: 9, exam: 56 },
      "History": { attitude: 9, homework: 9, quiz: 8, exam: 58 },
      "Geography": { attitude: 9, homework: 8, quiz: 9, exam: 56 },
      "ICT": { attitude: 10, homework: 9, quiz: 9, exam: 62 },
    },
    "STU-027": {
      "Mathematics": { attitude: 5, homework: 4, quiz: 5, exam: 35 },
      "Science": { attitude: 5, homework: 5, quiz: 4, exam: 33 },
      "English (First Language)": { attitude: 4, homework: 4, quiz: 4, exam: 30 },
      "Chinese (Second Language)": { attitude: 5, homework: 4, quiz: 5, exam: 33 },
      "Malay (First Language)": { attitude: 6, homework: 5, quiz: 5, exam: 38 },
      "Biology": { attitude: 5, homework: 4, quiz: 5, exam: 32 },
      "Chemistry": { attitude: 4, homework: 5, quiz: 4, exam: 31 },
      "Physics": { attitude: 5, homework: 4, quiz: 5, exam: 33 },
      "History": { attitude: 5, homework: 5, quiz: 5, exam: 35 },
      "Geography": { attitude: 5, homework: 4, quiz: 5, exam: 33 },
      "ICT": { attitude: 6, homework: 6, quiz: 5, exam: 40 },
    },
    "STU-028": {
      "Mathematics": { attitude: 8, homework: 7, quiz: 8, exam: 51 },
      "Science": { attitude: 8, homework: 8, quiz: 7, exam: 49 },
      "English (First Language)": { attitude: 7, homework: 7, quiz: 7, exam: 47 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 7, exam: 49 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 53 },
      "Biology": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 47 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
  ...
  "4A": {
    "STU-031": {
      ...
      "Science": { attitude: 9, homework: 9, quiz: 8, exam: 56 },
      "English (First Language)": { attitude: 8, homework: 8, quiz: 7, exam: 52 },
      "Chinese (Second Language)": { attitude: 9, homework: 8, quiz: 8, exam: 55 },
      "Malay (First Language)": { attitude: 10, homework: 9, quiz: 9, exam: 60 },
      "Biology": { attitude: 9, homework: 8, quiz: 8, exam: 55 },
      "Chemistry": { attitude: 8, homework: 9, quiz: 8, exam: 54 },
      "Physics": { attitude: 9, homework: 8, quiz: 8, exam: 56 },
      "History": { attitude: 9, homework: 9, quiz: 8, exam: 58 },
      "Geography": { attitude: 9, homework: 8, quiz: 8, exam: 56 },
      "ICT": { attitude: 10, homework: 10, quiz: 9, exam: 63 },
    },
    "STU-032": {
      "Mathematics": { attitude: 7, homework: 6, quiz: 6, exam: 48 },
      "Science": { attitude: 7, homework: 6, quiz: 6, exam: 45 },
      "English (First Language)": { attitude: 6, homework: 5, quiz: 5, exam: 42 },
      "Chinese (Second Language)": { attitude: 7, homework: 6, quiz: 6, exam: 44 },
      "Malay (First Language)": { attitude: 8, homework: 7, quiz: 7, exam: 50 },
      "Biology": { attitude: 7, homework: 6, quiz: 6, exam: 44 },
      "Chemistry": { attitude: 6, homework: 6, quiz: 6, exam: 43 },
      "Physics": { attitude: 7, homework: 6, quiz: 6, exam: 45 },
      "History": { attitude: 7, homework: 7, quiz: 6, exam: 48 },
      "Geography": { attitude: 7, homework: 6, quiz: 6, exam: 46 },
      "ICT": { attitude: 8, homework: 8, quiz: 7, exam: 52 },
    },
    "STU-033": {
      "Mathematics": { attitude: 8, homework: 8, quiz: 8, exam: 54 },
      "Science": { attitude: 8, homework: 7, quiz: 8, exam: 52 },
      "English (First Language)": { attitude: 7, homework: 8, quiz: 7, exam: 50 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 8, exam: 52 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 56 },
      "Biology": { attitude: 8, homework: 7, quiz: 8, exam: 51 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 50 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 52 },
      "History": { attitude: 8, homework: 8, quiz: 8, exam: 54 },
      "Geography": { attitude: 8, homework: 7, quiz: 8, exam: 52 },
      "ICT": { attitude: 9, homework: 9, quiz: 8, exam: 58 },
    },
    "STU-034": {
      "Mathematics": { attitude: 6, homework: 5, quiz: 5, exam: 38 },
      "Science": { attitude: 5, homework: 5, quiz: 5, exam: 35 },
      "English (First Language)": { attitude: 5, homework: 4, quiz: 4, exam: 32 },
      "Chinese (Second Language)": { attitude: 5, homework: 5, quiz: 5, exam: 36 },
      "Malay (First Language)": { attitude: 6, homework: 6, quiz: 5, exam: 40 },
      "Biology": { attitude: 5, homework: 5, quiz: 5, exam: 34 },
      "Chemistry": { attitude: 5, homework: 5, quiz: 4, exam: 33 },
      "Physics": { attitude: 6, homework: 5, quiz: 5, exam: 36 },
      "History": { attitude: 6, homework: 5, quiz: 5, exam: 38 },
      "Geography": { attitude: 5, homework: 5, quiz: 5, exam: 36 },
      "ICT": { attitude: 7, homework: 6, quiz: 6, exam: 44 },
    },
    "STU-035": {
      "Mathematics": { attitude: 10, homework: 10, quiz: 10, exam: 66 },
      "Science": { attitude: 10, homework: 10, quiz: 9, exam: 64 },
      "English (First Language)": { attitude: 9, homework: 10, quiz: 9, exam: 62 },
      "Chinese (Second Language)": { attitude: 10, homework: 9, quiz: 10, exam: 64 },
      "Malay (First Language)": { attitude: 10, homework: 10, quiz: 10, exam: 68 },
      "Biology": { attitude: 10, homework: 10, quiz: 10, exam: 63 },
      "Chemistry": { attitude: 9, homework: 10, quiz: 9, exam: 62 },
      "Physics": { attitude: 10, homework: 10, quiz: 10, exam: 64 },
      "History": { attitude: 10, homework: 10, quiz: 10, exam: 66 },
      "Geography": { attitude: 10, homework: 10, quiz: 9, exam: 64 },
      "ICT": { attitude: 10, homework: 10, quiz: 10, exam: 68 },
    },
    "STU-036": {
      "Mathematics": { attitude: 7, homework: 7, quiz: 7, exam: 48 },
    ...
    "STU-037": {
      "Mathematics": { attitude: 8, homework: 8, quiz: 7, exam: 51 },
      "Science": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "English (First Language)": { attitude: 7, homework: 7, quiz: 7, exam: 47 },
      "Chinese (Second Language)": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "Malay (First Language)": { attitude: 9, homework: 8, quiz: 8, exam: 53 },
      "Biology": { attitude: 8, homework: 7, quiz: 8, exam: 48 },
      "Chemistry": { attitude: 7, homework: 8, quiz: 7, exam: 47 },
      "Physics": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "History": { attitude: 8, homework: 8, quiz: 7, exam: 51 },
      "Geography": { attitude: 8, homework: 7, quiz: 8, exam: 49 },
      "ICT": { attitude: 9, homework: 8, quiz: 8, exam: 55 },
    },
    "STU-038": {
      "Mathematics": { attitude: 4, homework: 3, quiz: 4, exam: 28 },
      "Science": { attitude: 4, homework: 4, quiz: 3, exam: 26 },
      "English (First Language)": { attitude: 3, homework: 3, quiz: 3, exam: 22 },
      "Chinese (Second Language)": { attitude: 4, homework: 3, quiz: 4, exam: 26 },
      "Malay (First Language)": { attitude: 5, homework: 4, quiz: 4, exam: 30 },
      "Biology": { attitude: 4, homework: 3, quiz: 4, exam: 25 },
      "Chemistry": { attitude: 3, homework: 4, quiz: 3, exam: 24 },
      "Physics": { attitude: 4, homework: 3, quiz: 4, exam: 26 },
